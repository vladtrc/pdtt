...
Easing (`ease:smooth`) and the transition strategy (`transition:morph`, `transition:fade_in`, …)
come from modifier cells before the `->`; default is linear, direct interpolation.
